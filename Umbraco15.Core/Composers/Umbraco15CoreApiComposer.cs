...
namespace Umbraco15.Core.Composers
{
    public class Umbraco15CoreApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco 15Core Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<Umbraco15CoreOperationSecurityFilter>();
            });
        }

        public class Umbraco15CoreOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco15.Core.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
