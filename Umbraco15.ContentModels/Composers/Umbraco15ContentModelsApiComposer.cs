...
namespace Umbraco15.ContentModels.Composers
{
    public class Umbraco15ContentModelsApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco 15Content Models Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<Umbraco15ContentModelsOperationSecurityFilter>();
            });
        }

        public class Umbraco15ContentModelsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco15.ContentModels.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
